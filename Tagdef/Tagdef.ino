...
const char *ssid = "DESKTOP-L59N3LT 4534";
const char *password = "adi12345678";
const char *host = "192.168.8.67"; // Enter IP Address of server, e.g. 192.168.1.32

// MAC Addresses used for ESPNow protocol. Update section to include the MAC Addresses of the devices being used.
uint8_t tag_mac_addr[] =      { 0x64, 0xB7, 0x08, 0x6C, 0x37, 0x2C };
uint8_t anchor_mac_addr_1[] = { 0x64, 0xB7, 0x08, 0x6C, 0x67, 0x08 };
uint8_t anchor_mac_addr_2[] = { 0x64, 0xB7, 0x08, 0x6D, 0x86, 0x6C };
uint8_t anchor_mac_addr_3[] = { 0x64, 0xB7, 0x08, 0x6C, 0x1D, 0xCC };
uint8_t esp_mac_addrs[4][6] = {{0x64, 0xB7, 0x08, 0x6C, 0x37, 0x2C },
                               {0x64, 0xB7, 0x08, 0x6C, 0x67, 0x08  },
                               {0x64, 0xB7, 0x08, 0x6D, 0x86, 0x6C },
                               {0x64, 0xB7, 0x08, 0x6C, 0x1D, 0xCC }};
